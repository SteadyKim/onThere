...
public class BonusController {
    ...
    public String seoul(Model model) {
        ...
        TravelDto travelDto1 = new TravelDto("창경궁", "서울 종로구 창경궁로 185", "frontend/png/seoul1.jpg","http://cgg.cha.go.kr/agapp/main/index.do?siteCd=CGG");
        TravelDto travelDto2 = new TravelDto("별마당 도서관", "서울 강남구 영동대로 513", "frontend/png/seoul2.jpg","https://m.starfield.co.kr/coexmall/tenant/starfieldLibrary");
        TravelDto travelDto3 = new TravelDto("남산 타워", "서울 용산구 남산공원길 105", "frontend/png/seoul3.jpg", "https://www.seoultower.co.kr/");
        TravelDto travelDto4 = new TravelDto("롯데 타워", "서울 송파구 올림픽로 300", "frontend/png/seoul4.jpg","https://www.lwt.co.kr/ko/main/main.do");
        TravelDto travelDto5 = new TravelDto("여의도 한강공원", "서울 영등포구 여의동로 330", "frontend/png/seoul5.jpg","https://hangang.seoul.go.kr/archives/46758");
        TravelDto travelDto6 = new TravelDto("덕수궁", "서울 중구 세종대로 99", "frontend/png/seoul6.jpeg","http://www.deoksugung.go.kr/");
        TravelDto travelDto7 = new TravelDto("북촌 한옥마을", "서울 종로구 계동길 37", "frontend/png/seoul7.jpg","https://hanok.seoul.go.kr/front/index.do");
        TravelDto travelDto8 = new TravelDto("청계천", "서울 종로구 창신동", "frontend/png/seoul8.jpg","https://www.sisul.or.kr/open_content/cheonggye/");
//
    ...
    public String jeonju(Model model) {
        ArrayList<TravelDto> travelDtoArrayList = new ArrayList<>();
        TravelDto travelDto1 = new TravelDto("전주한옥마을", "전북 전주시 완산구 풍남동3가", "frontend/png/jeonju1.jpg","http://hanok.jeonju.go.kr/");
        TravelDto travelDto2 = new TravelDto("전주향교", "전북 전주시 완산구 교동 26-3", "frontend/png/jeonju2.jpg","http://www.jjhyanggyo.or.kr/");
        TravelDto travelDto3 = new TravelDto("전동성당", "전북 전주시 완산구 전동 200-1", "frontend/png/jeonju3.jpg","http://www.jeondong.or.kr/main/?load_popup=1");
